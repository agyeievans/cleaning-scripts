...
def process_tmx_to_excel(file_path, batch_size=1000000, output_path='ar-fr XLEnt.xlsx'):
    ...
    with pd.ExcelWriter(output_path, engine='openpyxl', mode='w') as writer:
        for event, elem in context:
            ...
            if len(fr_texts) >= batch_size or row_counter >= 1048576:  # Check for batch size or sheet limit
...
file_path = 'ar-fr XLEnt.tmx'  # File path on Google Colab
output_path = 'ar-fr XLEnt.xlsx'  # Output Excel file path
